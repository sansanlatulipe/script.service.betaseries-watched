...
class SettingsShould(unittest.TestCase):
    ...
    def setUp(self, addon: Addon) -> None:
        self.addon = addon
        self.configparser = mock.Mock()
        self.settings = Settings(self.addon, self.configparser)

    def test_get_addon_id_from_addon_info(self) -> None:
    ...
    def test_get_betaseries_api_key_from_config(self) -> None:
        expectedConfig = {
            'version': '1.0',
            'client_id': 'client',
    ...
    def test_get_synchronization_permission_from_addon_settings(self) -> None:
    ...
    def test_get_betaseries_mail_notification_permission_from_addon_settings(self) -> None:
        self.addon.getSetting = mock.Mock(return_value='true')
    ...
    def test_get_betaseries_twitter_notification_permission_from_addon_settings(self) -> None:
    ...
    def test_get_betaseries_profile_update_permission_from_addon_settings(self) -> None:
        self.addon.getSetting = mock.Mock(return_value='true')
